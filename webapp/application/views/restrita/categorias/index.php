                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-center">
                                ...
                                <a href="<?php echo base_url('restrita/'.$this->router->fetch_class().'/core/'.$categoria->categoria_id) ?>" data-toggle="tooltip" data-placement="top" title="Alterar" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                <a href="<?php echo base_url('restrita/'.$this->router->fetch_class().'/delete/'.$categoria->categoria_id) ?>" data-toggle="tooltip" data-placement="top" title="Deletar" class="btn btn-danger delete" data-confirm="Tem certeza da exclusão do registro?"><i class="fas fa-trash alt"></i></a>
                              </td>
                            </tr>
