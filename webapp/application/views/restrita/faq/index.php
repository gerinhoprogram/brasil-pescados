                        ...
                        <table class="table table-striped data-table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><?php echo character_limiter($faq->pergunta, 50) ?></td>
                              <td><?php echo character_limiter($faq->resposta, 50) ?></td>
                              <td class="text-center">
                                <!-- $this->router->fetch_class() - pega a função atual -->
                                <a href="<?php echo base_url('restrita/'.$this->router->fetch_class().'/core/'.$faq->faq_id) ?>" data-toggle="tooltip" data-placement="top" title="Alterar" class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                <a href="<?php echo base_url('restrita/'.$this->router->fetch_class().'/delete/'.$faq->faq_id) ?>" data-toggle="tooltip" data-placement="top" title="Deletar" class="btn btn-danger delete" data-confirm="Tem certeza da exclusão do registro?"><i class="fas fa-trash alt"></i></a>
                              </td>
                            </tr>
